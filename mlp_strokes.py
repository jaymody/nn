...
def main():
    ...
    from datasets import MnistStrokeSequencesImageDataset
    ...
    # load datasets
    train_data, test_data = MnistStrokeSequencesImageDataset.load_train_test_data(
        datafile_path
    )
    train_dataset = MnistStrokeSequencesImageDataset(train_data)
    test_dataset = MnistStrokeSequencesImageDataset(test_data)
